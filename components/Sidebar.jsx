...
const Sidebar = () => {
  return (
    <aside className="bg-[#171717] text-white w-64 p-4 h-full">
      <div class="group flex items-center gap-1 pb-4 justify-between  overflow-hidden ">
        <div
          type="button"
          id="radix-:rgd:"
          aria-haspopup="menu"
          aria-expanded="false"
          data-state="closed"
          class="group flex cursor-pointer items-center gap-1 justify-between rounded-lg pt-3 pb-3 pr-3 text-lg font-semibold hover:bg-token-main-surface-secondary radix-state-open:bg-token-main-surface-secondary  overflow-hidden  hover:bg-[#2F2F2F] "
        >
          <svg
        ...
        <div
          ...
          aria-expanded="false"
          data-state="closed"
          class="group flex cursor-pointer items-center gap-1 justify-between rounded-lg p-3 text-lg font-semibold hover:bg-token-main-surface-secondary radix-state-open:bg-token-main-surface-secondary  overflow-hidden  hover:bg-[#2F2F2F] "
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
      ...
      <div
        ...
        aria-expanded="false"
        data-state="closed"
        class="group flex cursor-pointer items-center gap-1 rounded-lg py-1.5 text-[12px] font-semibold hover:bg-token-main-surface-secondary radix-state-open:bg-token-main-surface-secondary text-token-text-secondary overflow-hidden whitespace-nowrap  hover:bg-[#2F2F2F] focus:ring-4 focus:outline-none"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
